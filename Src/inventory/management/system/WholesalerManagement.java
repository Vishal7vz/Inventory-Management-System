...
public class WholesalerManagement extends JFrame implements ActionListener {
    ...
    public WholesalerManagement() {
        setTitle("WholesalerManagement");
        ...
        JLabel title = new JLabel("Inventory Management System - Whole Seller Management");
        ...
        btnUpdate = new Button("Update Wholesaler");
        btnUpdate.setBackground(new Color(42, 21, 127));
        btnAdd = new Button("Add Wholesaler");
        btnAdd.setBackground(new Color(122, 21, 127));
        btnShow = new Button("Show Wholesaler");
        btnShow.setBackground(new Color(42, 21, 127));
        btnDelete = new Button("Delete Wholesaler");
    ...
    private JPanel createShowPanel() {
        ...
        JLabel title = new JLabel("Show Wholesaler");
    ...
    private JPanel createAddPanel() {
        ...
        JLabel title = new JLabel("Add Wholesaler");
        title.setFont(new Font("SansSerif", Font.BOLD, 30));
        title.setForeground(Color.WHITE);
        ...
        saveBtn.addActionListener(e -> {
            ...
            if (!isCompanyEmail(email)) {
                JOptionPane.showMessageDialog(panel, "Please provide a company email address.", "Invalid Email",
                        JOptionPane.WARNING_MESSAGE);
                return;
            }
    ...
    private JPanel createUpdatePanel() {
        ...
        JLabel title = new JLabel("Update Wholesaler");
        title.setFont(new Font("SansSerif", Font.BOLD, 30));
        title.setForeground(Color.WHITE);
        title.setBorder(BorderFactory.createEmptyBorder(20, 20, 20, 20));
        ...
        JLabel idLbl = new JLabel("Search By Wholesaler ID: ");
        idLbl.setFont(new Font("SansSerif", Font.BOLD, 22));
        idLbl.setForeground(Color.WHITE);
        idLbl.setBackground(Color.WHITE);
        ...
        loadBtn.addActionListener(e -> {
            // TODO : Load from the Table if wholesaler exists.

            String id = txtId.getText().trim();
            if (id.isEmpty()) {
                JOptionPane.showMessageDialog(panel, "Enter a Wholesaler ID to search.", "Input needed",
                        JOptionPane.INFORMATION_MESSAGE);
                return;
            }
            ...
            if (tableModel == null || tableModel.getRowCount() == 0) {
                JOptionPane.showMessageDialog(panel,
                        "No whole seller data available. Click 'Show Wholesaler' to load data.",
            ...
            if (!found) {
                JOptionPane.showMessageDialog(panel,
                        "Wholesaler with ID '" + id + "' not found.",
    ...
    private JPanel createDeletePanel() {
        ...
        JLabel title = new JLabel("Delete Wholesaler");
        title.setFont(new Font("SansSerif", Font.BOLD, 30));
        title.setBorder(BorderFactory.createEmptyBorder(20, 20, 20, 20));
        title.setForeground(Color.WHITE);

        // Form: show search row + wholesaler details (read-only)
        JPanel form = new JPanel(new GridLayout(10, 2, 20, 20));
        form.setBorder(BorderFactory.createEmptyBorder(50, 100, 50, 100));
        form.setBackground(new Color(30, 41, 59));
        ...
        JLabel nameLbl = new JLabel("Whole Seller Name:");
        nameLbl.setFont(new Font("SansSerif", Font.BOLD, 22));
        nameLbl.setForeground(Color.WHITE);
        ...
        searchBtn.addActionListener(e -> {
            ...
            if (!found) {
                JOptionPane.showMessageDialog(panel, "Whole Seller with ID '" + id + "' not found.", "Not found",
                        JOptionPane.INFORMATION_MESSAGE);
                foundIndex[0] = -1;
        ...
        deleteBtn.addActionListener(e -> {
            if (foundIndex[0] == -1) {
                JOptionPane.showMessageDialog(panel, "No Wholesaler selected to delete. Please search first.",
                        "Nothing to delete", JOptionPane.INFORMATION_MESSAGE);
                return;
            }

            int confirm = JOptionPane.showConfirmDialog(panel, "Are you sure you want to delete this whole seller?",
                    "Confirm Delete", JOptionPane.YES_NO_OPTION);
            if (confirm == JOptionPane.YES_OPTION) {
                if (tableModel != null && foundIndex[0] >= 0 && foundIndex[0] < tableModel.getRowCount()) {
                    tableModel.removeRow(foundIndex[0]);
                    JOptionPane.showMessageDialog(panel, "Wholesaler deleted.", "Deleted",
                            JOptionPane.INFORMATION_MESSAGE);
                }
                foundIndex[0] = -1;
                txtId.setText("");
